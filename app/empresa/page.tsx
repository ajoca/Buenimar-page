    ...
    <div className="min-h-screen" style={{ background: "rgb(var(--bg))", color: "rgb(var(--text))" }}>
      ...
      <main className="pt-0 pb-0">
        ...
        <section className="relative pb-12 pt-0">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 text-white pt-10 pb-6">
            <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-8 drop-shadow-2xl">NUESTRA HISTORIA</h2>
            <div className="bg-white/90 text-black p-8 rounded-lg shadow-lg">
            ...
            <h3 className="mt-10 text-3xl font-bold text-center mb-6 text-white">CULTURA DE CALIDAD</h3>
            <div className="bg-white/90 text-black p-8 rounded-lg shadow-lg">
