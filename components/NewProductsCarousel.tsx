...
export default function NewProductsCarousel() {
  ...
  return (
    <div className="w-full flex flex-col items-center pt-2 sm:pt-3 pb-8 sm:pb-10 px-3 sm:px-4 overflow-hidden">
      <div
        className="-mt-2 sm:-mt-3 mb-6 sm:mb-7 w-full max-w-2xl rounded-2xl border px-3 py-3 sm:px-4 sm:py-3.5 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-3"
        style={{
